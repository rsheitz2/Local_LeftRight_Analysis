...
if [ $# -ne 11 ]; then
    echo "" 
    echo "Script updates sysFunctMFit.C with input paramters"
    echo ""
    exit 1
fi
...
changeFile=/Users/robertheitz/Documents/Research/DrellYan/Analysis/TGeant/Local_LeftRight_Analysis/Macros/Systematics/FalseAsym/sysFunctMFit.C
