...
if [ $# -ne 12 ]; then
     echo "" 
     echo "Script updates mcMFit.C with input paramters"
     echo ""
    ...
    changeFile=/Users/robertheitz/Documents/Research/DrellYan/Analysis/TGeant/Local_LeftRight_Analysis/Macros/AN_calculation/mcMFit.C
